...
$azsdkPipelineSubnetMap = @{
    "azsdk-pool-mms-ubuntu-1804-general" = ($azsdkPipelineVnet + "/subnets/pipeline-subnet-ubuntu-1804-general")
    "azsdk-pool-mms-ubuntu-2004-general" = ($azsdkPipelineVnet + "/subnets/pipeline-subnet-ubuntu-2004-general")
    "azsdk-pool-mms-ubuntu-2204-general" = ($azsdkPipelineVnet + "/subnets/pipeline-subnet-ubuntu-2204-general")
    "azsdk-pool-mms-win-2019-general" = ($azsdkPipelineVnet + "/subnets/pipeline-subnet-win-2019-general")
    "azsdk-pool-mms-win-2022-general" = ($azsdkPipelineVnet + "/subnets/pipeline-subnet-win-2022-general")
    "azsdk-pool-mms-ubuntu-1804-storage" = ($azsdkPipelineVnet + "/subnets/pipeline-subnet-ubuntu-1804-storage")
    "azsdk-pool-mms-ubuntu-2004-storage" = ($azsdkPipelineVnet + "/subnets/pipeline-subnet-ubuntu-2004-storage")
    "azsdk-pool-mms-win-2019-storage" = ($azsdkPipelineVnet + "/subnets/pipeline-subnet-win-2019-storage")
    "azsdk-pool-mms-win-2022-storage" = ($azsdkPipelineVnet + "/subnets/pipeline-subnet-win-2022-storage")
}

Write-Host "bebroder test pool: '$($env:Pool)'"
Write-Host "bebroder subnet mapping: '$($azsdkPipelineSubnetMap[$env:Pool])'"
exit 1
