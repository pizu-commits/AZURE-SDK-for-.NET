...
namespace Azure.Developer.DevCenter.Models
{
    ...
    public partial class OperationStatus
    {
        ...
        internal OperationStatus(string status)
        {
        ...
        internal OperationStatus(string id, string name, string status, string resourceId, DateTimeOffset? startTime, DateTimeOffset? endTime, float? percentComplete, BinaryData properties, OperationStatusError error)
        {
            Id = id;
            Name = name;
            Status = status;
