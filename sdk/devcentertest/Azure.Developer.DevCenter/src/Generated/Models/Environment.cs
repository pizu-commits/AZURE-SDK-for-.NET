...
namespace Azure.Developer.DevCenter.Models
{
    ...
    public partial class Environment
    {
        ...
        internal Environment(BinaryData parameters, string name, string environmentType, string user, string provisioningState, string resourceGroupId, string catalogName, string environmentDefinitionName, CloudErrorBody error)
        {
