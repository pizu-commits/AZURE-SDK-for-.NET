...
namespace Azure.Developer.DevCenter.Models
{
    ...
    public static partial class DeveloperDevCenterModelFactory
    {
        ...
        public static Environment Environment(BinaryData parameters = null, string name = null, string environmentType = null, string user = null, string provisioningState = null, string resourceGroupId = null, string catalogName = null, string environmentDefinitionName = null, CloudErrorBody error = null)
        {
        ...
        public static OperationStatus OperationStatus(string id = null, string name = null, string status = null, string resourceId = null, DateTimeOffset? startTime = null, DateTimeOffset? endTime = null, float? percentComplete = null, BinaryData properties = null, OperationStatusError error = null)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/>, <paramref name="time"/> or <paramref name="timeZone"/> is null. </exception>
        ...
        public static DevBoxActionDelayResult DevBoxActionDelayResult(string name = null, DevBoxActionDelayResultStatus result = default, DevBoxAction action = null, CloudErrorBody error = null)
        {
