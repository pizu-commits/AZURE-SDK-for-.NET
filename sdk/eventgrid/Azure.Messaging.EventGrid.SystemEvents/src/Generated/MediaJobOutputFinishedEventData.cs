...
{
    /// <summary> The MediaJobOutputFinishedEventData. </summary>
    public partial class MediaJobOutputFinishedEventData : MediaJobOutputStateChangeEventData
    {
        ...
        internal MediaJobOutputFinishedEventData(MediaJobState previousState, MediaJobOutput output, IReadOnlyDictionary<string, string> jobCorrelationData, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(previousState, output, jobCorrelationData, serializedAdditionalRawData)
        {
        }

        /// <summary> Initializes a new instance of <see cref="MediaJobOutputFinishedEventData"/> for deserialization. </summary>
