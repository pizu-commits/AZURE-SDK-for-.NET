...
{
    /// <summary> The KeyVaultKeyExpiredEventData. </summary>
    public partial class KeyVaultKeyExpiredEventData
    {
        ...
        internal KeyVaultKeyExpiredEventData(string id, string vaultName, string objectType, string objectName, string version, float? nbf, float? exp, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            VaultName = vaultName;
