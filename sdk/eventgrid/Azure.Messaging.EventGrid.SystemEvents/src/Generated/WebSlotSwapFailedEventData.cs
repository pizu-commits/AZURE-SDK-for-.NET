...
{
    /// <summary> The WebSlotSwapFailedEventData. </summary>
    public partial class WebSlotSwapFailedEventData
    {
        ...
        internal WebSlotSwapFailedEventData(AppEventTypeDetail appEventTypeDetail)
        {
        ...
        internal WebSlotSwapFailedEventData(AppEventTypeDetail appEventTypeDetail, string name, string clientRequestId, string correlationRequestId, string requestId, string address, string verb, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AppEventTypeDetail = appEventTypeDetail;
            Name = name;
        ...
        /// <summary> Initializes a new instance of <see cref="WebSlotSwapFailedEventData"/> for deserialization. </summary>
