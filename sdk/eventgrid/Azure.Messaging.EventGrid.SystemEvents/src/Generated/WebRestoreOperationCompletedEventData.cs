...
{
    /// <summary> The WebRestoreOperationCompletedEventData. </summary>
    public partial class WebRestoreOperationCompletedEventData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WebRestoreOperationCompletedEventData"/>. </summary>
        ...
        internal WebRestoreOperationCompletedEventData(AppEventTypeDetail appEventTypeDetail)
        {
        ...
        internal WebRestoreOperationCompletedEventData(AppEventTypeDetail appEventTypeDetail, string name, string clientRequestId, string correlationRequestId, string requestId, string address, string verb, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AppEventTypeDetail = appEventTypeDetail;
            Name = name;
        ...
        /// <summary> Initializes a new instance of <see cref="WebRestoreOperationCompletedEventData"/> for deserialization. </summary>
