...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class AnalyzeBatchDocumentsContent
    {
        ...
        {
            Argument.AssertNotNull(resultContainerUrl, nameof(resultContainerUrl));
        ...
        /// <summary> Initializes a new instance of <see cref="AnalyzeBatchDocumentsContent"/> for deserialization. </summary>
        internal AnalyzeBatchDocumentsContent()
        {
        }
