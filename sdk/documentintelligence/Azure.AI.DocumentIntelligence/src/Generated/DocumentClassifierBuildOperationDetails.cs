...
{
    /// <summary> The DocumentClassifierBuildOperationDetails. </summary>
    public partial class DocumentClassifierBuildOperationDetails : OperationDetails
    {
        ...
        internal DocumentClassifierBuildOperationDetails(string operationId, OperationStatus status, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, Uri resourceLocation) : base(operationId, status, createdOn, lastUpdatedOn, resourceLocation)
        {
