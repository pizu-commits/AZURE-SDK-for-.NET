...
{
    /// <summary> The DocumentClassifierCopyToOperationDetails. </summary>
    public partial class DocumentClassifierCopyToOperationDetails : OperationDetails
    {
        /// <summary> Initializes a new instance of <see cref="DocumentClassifierCopyToOperationDetails"/>. </summary>
        ...
        internal DocumentClassifierCopyToOperationDetails(string operationId, OperationStatus status, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, Uri resourceLocation) : base(operationId, status, createdOn, lastUpdatedOn, resourceLocation)
        {
            Argument.AssertNotNull(operationId, nameof(operationId));
            Argument.AssertNotNull(resourceLocation, nameof(resourceLocation));

            Kind = OperationKind.DocumentClassifierCopyTo;
        }
