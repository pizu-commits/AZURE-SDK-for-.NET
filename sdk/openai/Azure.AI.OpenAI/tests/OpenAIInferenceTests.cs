...
namespace Azure.AI.OpenAI.Tests
{
    public class OpenAIInferenceTests : OpenAITestBase
    {
        ...
        {
            await this.SetProxyOptionsAsync(new Core.TestFramework.Models.ProxyOptions() {
                Transport = new Core.TestFramework.Models.ProxyOptionsTransport()
                {
                    PlaybackResponseTime = 1000
                }
            });
            /**
