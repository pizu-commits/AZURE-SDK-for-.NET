...
namespace Azure.ResourceManager.MachineLearning
{
    public partial class MachineLearningRegistryData : IUtf8JsonSerializable, IJsonModel<MachineLearningRegistryData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue("ManagedResourceGroupAssignedIdentities", out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    managedResourceGroupSettings: ");
                builder.AppendLine("{");
                builder.AppendLine("      managedResourceGroupSettings: {");
            ...
            else
            {
                ...
                {
                    builder.Append("    managedResourceGroupSettings: ");
                    BicepSerializationHelpers.AppendChildObject(builder, ManagedResourceGroupSettings, options, 4, false, "    managedResourceGroupSettings: ");
                }
            }
