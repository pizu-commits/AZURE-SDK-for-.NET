...
{
    public partial class OpenAIEndpointDeploymentResourceProperties : IUtf8JsonSerializable, IJsonModel<OpenAIEndpointDeploymentResourceProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OpenAIEndpointDeploymentResourceProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<OpenAIEndpointDeploymentResourceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OpenAIEndpointDeploymentResourceProperties)} does not support writing '{format}' format.");
            }
        ...
        OpenAIEndpointDeploymentResourceProperties IJsonModel<OpenAIEndpointDeploymentResourceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<OpenAIEndpointDeploymentResourceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OpenAIEndpointDeploymentResourceProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeOpenAIEndpointDeploymentResourceProperties(document.RootElement, options);
        }

        internal static OpenAIEndpointDeploymentResourceProperties DeserializeOpenAIEndpointDeploymentResourceProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        OpenAIEndpointDeploymentResourceProperties IPersistableModel<OpenAIEndpointDeploymentResourceProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<OpenAIEndpointDeploymentResourceProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OpenAIEndpointDeploymentResourceProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<OpenAIEndpointDeploymentResourceProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
