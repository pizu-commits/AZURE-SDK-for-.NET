...
{
    public partial class ContentSafetyEndpointResourceProperties : IUtf8JsonSerializable, IJsonModel<ContentSafetyEndpointResourceProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentSafetyEndpointResourceProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ContentSafetyEndpointResourceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContentSafetyEndpointResourceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ContentSafetyEndpointResourceProperties IJsonModel<ContentSafetyEndpointResourceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContentSafetyEndpointResourceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ContentSafetyEndpointResourceProperties DeserializeContentSafetyEndpointResourceProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ContentSafetyEndpointResourceProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContentSafetyEndpointResourceProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ContentSafetyEndpointResourceProperties IPersistableModel<ContentSafetyEndpointResourceProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContentSafetyEndpointResourceProperties>)this).GetFormatFromOptions(options) : options.Format;
