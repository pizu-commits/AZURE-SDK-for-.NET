...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningComputeInstanceProperties : IUtf8JsonSerializable, IJsonModel<MachineLearningComputeInstanceProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue("MlflowAutologger", out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("  autologgerSettings: ");
                    BicepSerializationHelpers.AppendChildObject(builder, AutologgerSettings, options, 2, false, "  autologgerSettings: ");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(EnableOSPatching), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  enableOSPatching: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  enableOSPatching: ");
                    var boolValue = EnableOSPatching.Value == true ? "true" : "false";
                    builder.AppendLine($"{boolValue}");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(EnableRootAccess), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  enableRootAccess: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  enableRootAccess: ");
                    var boolValue = EnableRootAccess.Value == true ? "true" : "false";
                    builder.AppendLine($"{boolValue}");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(EnableSso), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  enableSSO: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  enableSSO: ");
                    var boolValue = EnableSso.Value == true ? "true" : "false";
                    builder.AppendLine($"{boolValue}");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ReleaseQuotaOnStop), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  releaseQuotaOnStop: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  releaseQuotaOnStop: ");
                    var boolValue = ReleaseQuotaOnStop.Value == true ? "true" : "false";
                    builder.AppendLine($"{boolValue}");
                }
            }
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(IdleTimeBeforeShutdown), out propertyOverride);
            if (hasPropertyOverride)
            {
