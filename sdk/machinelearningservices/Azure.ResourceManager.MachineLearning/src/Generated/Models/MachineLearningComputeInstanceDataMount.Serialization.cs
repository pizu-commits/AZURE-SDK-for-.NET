...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningComputeInstanceDataMount : IUtf8JsonSerializable, IJsonModel<MachineLearningComputeInstanceDataMount>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(MountMode), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  mountMode: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  mountMode: ");
                    builder.AppendLine($"'{MountMode.Value.ToString()}'");
                }
            }
