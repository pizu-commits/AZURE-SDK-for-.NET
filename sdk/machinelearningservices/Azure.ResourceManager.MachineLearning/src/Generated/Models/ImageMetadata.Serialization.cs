...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class ImageMetadata : IUtf8JsonSerializable, IJsonModel<ImageMetadata>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(OSPatchingStatus), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  osPatchingStatus: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(OSPatchingStatus))
                {
                    builder.Append("  osPatchingStatus: ");
                    BicepSerializationHelpers.AppendChildObject(builder, OSPatchingStatus, options, 2, false, "  osPatchingStatus: ");
                }
            }
