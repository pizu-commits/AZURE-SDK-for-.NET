...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduleResourceArmPaginatedResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<ScheduleResourceArmPaginatedResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ScheduleResourceArmPaginatedResult)} does not support writing '{format}' format.");
            }
        ...
        ScheduleResourceArmPaginatedResult IJsonModel<ScheduleResourceArmPaginatedResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ScheduleResourceArmPaginatedResult)} does not support reading '{format}' format.");
            }
        ...
        internal static ScheduleResourceArmPaginatedResult DeserializeScheduleResourceArmPaginatedResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<MachineLearningScheduleData> value = default;
            ...
            return new ScheduleResourceArmPaginatedResult(nextLink, value ?? new ChangeTrackingList<MachineLearningScheduleData>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ScheduleResourceArmPaginatedResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ScheduleResourceArmPaginatedResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ScheduleResourceArmPaginatedResult IPersistableModel<ScheduleResourceArmPaginatedResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ScheduleResourceArmPaginatedResult)} does not support reading '{options.Format}' format.");
            }
        }
