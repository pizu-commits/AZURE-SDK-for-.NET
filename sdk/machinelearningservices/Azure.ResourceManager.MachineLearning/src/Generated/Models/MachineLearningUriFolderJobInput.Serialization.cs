...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningUriFolderJobInput>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<MachineLearningUriFolderJobInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningUriFolderJobInput)} does not support writing '{format}' format.");
            }
        ...
        MachineLearningUriFolderJobInput IJsonModel<MachineLearningUriFolderJobInput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningUriFolderJobInput)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MachineLearningUriFolderJobInput>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MachineLearningUriFolderJobInput)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MachineLearningUriFolderJobInput IPersistableModel<MachineLearningUriFolderJobInput>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MachineLearningUriFolderJobInput)} does not support reading '{options.Format}' format.");
            }
        }
