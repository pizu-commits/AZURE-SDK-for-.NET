...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class CustomService : IUtf8JsonSerializable, IJsonModel<CustomService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(Kernel), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("  kernel: ");
                    BicepSerializationHelpers.AppendChildObject(builder, Kernel, options, 2, false, "  kernel: ");
                }
            }
