...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FeaturesetContainerResourceArmPaginatedResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<FeaturesetContainerResourceArmPaginatedResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FeaturesetContainerResourceArmPaginatedResult)} does not support writing '{format}' format.");
            }
        ...
        FeaturesetContainerResourceArmPaginatedResult IJsonModel<FeaturesetContainerResourceArmPaginatedResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FeaturesetContainerResourceArmPaginatedResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FeaturesetContainerResourceArmPaginatedResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FeaturesetContainerResourceArmPaginatedResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        FeaturesetContainerResourceArmPaginatedResult IPersistableModel<FeaturesetContainerResourceArmPaginatedResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FeaturesetContainerResourceArmPaginatedResult)} does not support reading '{options.Format}' format.");
            }
        }
