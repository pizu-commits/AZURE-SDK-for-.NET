...
namespace Azure.Developer.DevCenter.Models
{
    ...
    public partial class EnvironmentDeployOperation : EnvironmentOperation
    {
        /// <summary> Initializes a new instance of <see cref="EnvironmentDeployOperation"/>. </summary>
        /// <param name="uri"> The unique URI for the environment operation. </param>
        /// <param name="status"> The operation status. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="uri"/> is null. </exception>
        internal EnvironmentDeployOperation(Uri uri, DevCenterOperationStatus status) : base(uri, status)
        {
