...
namespace Azure.Developer.DevCenter.Models
{
    ...
    /// </summary>
    internal abstract partial class DevBoxOperation
    {
        /// <summary>
        ...
        internal DevBoxOperation(Uri uri, Guid operationId, string kind, DevCenterOperationStatus status, Guid? createdByObjectId, DateTimeOffset? startTime, DateTimeOffset? endTime, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uri = uri;
