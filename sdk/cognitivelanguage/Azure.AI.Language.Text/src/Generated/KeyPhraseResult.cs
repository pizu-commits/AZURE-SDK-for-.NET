...
namespace Azure.AI.Language.Text
{
    ...
    public partial class KeyPhraseResult
    {
        ...
        internal KeyPhraseResult(IEnumerable<DocumentError> errors, string modelVersion, IEnumerable<KeyPhrasesActionResult> documents)
        {
        ...
        internal KeyPhraseResult(IReadOnlyList<DocumentError> errors, RequestStatistics statistics, string modelVersion, IReadOnlyList<KeyPhrasesActionResult> documents, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Errors = errors;
        ...
        public IReadOnlyList<KeyPhrasesActionResult> Documents { get; }
    }
}
