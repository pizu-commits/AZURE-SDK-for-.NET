...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class HDInsightLinkedService : DataFactoryLinkedServiceProperties
    {
        ...
        internal HDInsightLinkedService(string linkedServiceType, IntegrationRuntimeReference connectVia, string description, IDictionary<string, EntityParameterSpecification> parameters, IList<BinaryData> annotations, IDictionary<string, BinaryData> additionalProperties, DataFactoryElement<string> clusterUri, DataFactoryElement<string> userName, DataFactorySecretBaseDefinition password, Core.Expressions.DataFactory.DataFactoryLinkedServiceReference linkedServiceName, Core.Expressions.DataFactory.DataFactoryLinkedServiceReference hcatalogLinkedServiceName, string encryptedCredential, DataFactoryElement<bool> isEspEnabled, DataFactoryElement<string> fileSystem) : base(linkedServiceType, connectVia, description, parameters, annotations, additionalProperties)
        {
            ClusterUri = clusterUri;
            UserName = userName;
            Password = password;
