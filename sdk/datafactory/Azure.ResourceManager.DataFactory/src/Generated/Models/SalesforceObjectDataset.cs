...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="SalesforceObjectDataset"/>. </summary>
        /// <param name="linkedServiceName"> Linked service reference. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="linkedServiceName"/> is null. </exception>
        public SalesforceObjectDataset(Core.Expressions.DataFactory.DataFactoryLinkedServiceReference linkedServiceName) : base(linkedServiceName)
        {
