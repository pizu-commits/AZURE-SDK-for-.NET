...
namespace Azure.ResourceManager.DataFactory.Models
{
    ...
    public partial class LogStorageSettings
    {
        ...
        public LogStorageSettings(Core.Expressions.DataFactory.DataFactoryLinkedServiceReference linkedServiceName)
        {
        ...
        internal LogStorageSettings(Core.Expressions.DataFactory.DataFactoryLinkedServiceReference linkedServiceName, DataFactoryElement<string> path, DataFactoryElement<string> logLevel, DataFactoryElement<bool> enableReliableLogging, IDictionary<string, BinaryData> additionalProperties)
        {
            LinkedServiceName = linkedServiceName;
            Path = path;
            LogLevel = logLevel;
