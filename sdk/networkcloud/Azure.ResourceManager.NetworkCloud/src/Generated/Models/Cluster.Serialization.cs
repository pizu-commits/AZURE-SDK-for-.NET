...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    public partial class Cluster : IUtf8JsonSerializable
    {
        ...
        internal static Cluster DeserializeCluster(JsonElement element)
        {
            ...
            Optional<string> clusterManagerId = default;
            ...
            Optional<IList<RackDefinition>> computeRackDefinitions = default;
            ...
            Optional<IReadOnlyList<string>> workloadResourceIds = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            aggregatorOrSingleRackDefinition = RackDefinition.DeserializeRackDefinition(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("analyticsWorkspaceId"u8))
                        {
                            analyticsWorkspaceId = property0.Value.GetString();
                            continue;
                        }
                        ...
                        {
                            clusterManagerId = property0.Value.GetString();
                            continue;
                        }
                        ...
                        if (property0.NameEquals("computeRackDefinitions"u8))
                        {
                            ...
                            List<RackDefinition> array = new List<RackDefinition>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(RackDefinition.DeserializeRackDefinition(item));
                            }
                        ...
                        {
                            supportExpiryDate = property0.Value.GetString();
                            continue;
                        }
