...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    public partial class ClusterManager : TrackedResourceData
    {
        ...
        public ClusterManager(AzureLocation location, string fabricControllerId) : base(location)
        {
