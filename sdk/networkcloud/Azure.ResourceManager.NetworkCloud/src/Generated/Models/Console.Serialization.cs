...
{
    public partial class Console : IUtf8JsonSerializable
    {
        ...
        internal static Console DeserializeConsole(JsonElement element)
        {
            ...
            Optional<string> virtualMachineAccessId = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            sshPublicKey = SshPublicKey.DeserializeSshPublicKey(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("virtualMachineAccessId"u8))
                        {
                            virtualMachineAccessId = property0.Value.GetString();
                            continue;
                        }
                    }
                    continue;
            ...
            return new Console(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation, Optional.ToNullable(detailedStatus), detailedStatusMessage.Value, enabled, Optional.ToNullable(expiration), privateLinkServiceId.Value, Optional.ToNullable(provisioningState), sshPublicKey, virtualMachineAccessId.Value);
        }
    }
}
