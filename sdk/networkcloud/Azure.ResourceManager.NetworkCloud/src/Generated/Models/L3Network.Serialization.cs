...
{
    public partial class L3Network : IUtf8JsonSerializable
    {
        ...
        internal static L3Network DeserializeL3Network(JsonElement element)
        {
            ...
            string l3IsolationDomainId = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            l3IsolationDomainId = property0.Value.GetString();
                            continue;
                        }
