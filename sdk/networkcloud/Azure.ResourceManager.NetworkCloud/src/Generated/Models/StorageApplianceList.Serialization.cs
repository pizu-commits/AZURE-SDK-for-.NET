...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    internal partial class StorageApplianceList
    {
        internal static StorageApplianceList DeserializeStorageApplianceList(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<StorageAppliance>> value = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("value"u8))
                {
                    ...
                    List<StorageAppliance> array = new List<StorageAppliance>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(StorageAppliance.DeserializeStorageAppliance(item));
                    }
                    value = array;
                    continue;
                }
