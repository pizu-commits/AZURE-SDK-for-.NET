...
{
    public partial class ClusterManager : IUtf8JsonSerializable
    {
        ...
        internal static ClusterManager DeserializeClusterManager(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            fabricControllerId = property0.Value.GetString();
                            continue;
                        }
