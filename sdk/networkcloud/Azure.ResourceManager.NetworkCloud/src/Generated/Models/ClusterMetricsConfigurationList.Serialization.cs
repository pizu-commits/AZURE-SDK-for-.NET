...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    internal partial class ClusterMetricsConfigurationList
    {
        internal static ClusterMetricsConfigurationList DeserializeClusterMetricsConfigurationList(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<ClusterMetricsConfiguration>> value = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("value"u8))
                {
                    ...
                    List<ClusterMetricsConfiguration> array = new List<ClusterMetricsConfiguration>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ClusterMetricsConfiguration.DeserializeClusterMetricsConfiguration(item));
                    }
                    value = array;
                    continue;
                }
