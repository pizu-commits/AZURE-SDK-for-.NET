...
{
    public partial class Rack : IUtf8JsonSerializable
    {
        ...
        internal static Rack DeserializeRack(JsonElement element)
        {
            ...
            return new Rack(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation, availabilityZone, clusterId.Value, Optional.ToNullable(detailedStatus), detailedStatusMessage.Value, Optional.ToNullable(provisioningState), rackLocation, rackSerialNumber, rackSkuId);
        }
    }
}
