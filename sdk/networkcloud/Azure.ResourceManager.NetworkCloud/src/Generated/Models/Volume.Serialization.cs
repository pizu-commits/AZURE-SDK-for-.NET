...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    public partial class Volume : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            writer.WriteNumberValue(SizeMiB);
            writer.WriteEndObject();
            writer.WriteEndObject();
        }
        ...
        internal static Volume DeserializeVolume(JsonElement element)
        {
            ...
            return new Volume(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation, Optional.ToList(attachedTo), Optional.ToNullable(detailedStatus), detailedStatusMessage.Value, Optional.ToNullable(provisioningState), serialNumber.Value, sizeMiB);
        }
    }
}
