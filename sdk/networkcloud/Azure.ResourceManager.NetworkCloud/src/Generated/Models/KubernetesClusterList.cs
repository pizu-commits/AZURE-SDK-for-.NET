...
namespace Azure.ResourceManager.NetworkCloud.Models
{
    ...
    internal partial class KubernetesClusterList
    {
        ...
        {
            Value = new ChangeTrackingList<KubernetesCluster>();
        }

        /// <summary> Initializes a new instance of KubernetesClusterList. </summary>
        /// <param name="nextLink"> The link used to get the next page of operations. </param>
        /// <param name="value"> The list of additional details related to Kubernetes clusters. </param>
        internal KubernetesClusterList(string nextLink, IReadOnlyList<KubernetesCluster> value)
        {
            NextLink = nextLink;
            Value = value;
        }
        ...
        public IReadOnlyList<KubernetesCluster> Value { get; }
    }
}
