...
{
    /// <summary> The ExitOptions. </summary>
    public partial class ExitOptions
    {
        ...
        internal ExitOptions(BatchJobAction? jobAction, DependencyAction? dependencyAction, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobAction = jobAction;
        ...
        /// <summary> Gets or sets the dependency action. </summary>
