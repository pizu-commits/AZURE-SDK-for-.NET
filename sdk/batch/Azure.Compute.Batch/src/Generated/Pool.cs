...
namespace Azure.Compute.Batch
{
    ...
    public partial class Pool
    {
        ...
        internal Pool(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        /// </remarks>
        public virtual async Task<Response> EnableAutoScaleAsync(string poolId, BatchPoolEnableAutoScaleParameters poolEnableAutoScaleParameter, int? timeOut = null, string clientRequestId = null, bool? returnClientRequestId = null, string ocpDate = null, RequestConditions requestConditions = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(poolId, nameof(poolId));
            Argument.AssertNotNull(poolEnableAutoScaleParameter, nameof(poolEnableAutoScaleParameter));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await EnableAutoScaleAsync(poolId, poolEnableAutoScaleParameter.ToRequestContent(), timeOut, clientRequestId, returnClientRequestId, ocpDate, requestConditions, context).ConfigureAwait(false);
            return response;
        }
        ...
        /// more than once every 30 seconds.
        /// </remarks>
        public virtual Response EnableAutoScale(string poolId, BatchPoolEnableAutoScaleParameters poolEnableAutoScaleParameter, int? timeOut = null, string clientRequestId = null, bool? returnClientRequestId = null, string ocpDate = null, RequestConditions requestConditions = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(poolId, nameof(poolId));
            Argument.AssertNotNull(poolEnableAutoScaleParameter, nameof(poolEnableAutoScaleParameter));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = EnableAutoScale(poolId, poolEnableAutoScaleParameter.ToRequestContent(), timeOut, clientRequestId, returnClientRequestId, ocpDate, requestConditions, context);
            return response;
        }
