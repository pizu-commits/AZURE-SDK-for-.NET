...
{
    public partial class JobSchedulingError : IUtf8JsonSerializable
    {
        ...
        internal static JobSchedulingError DeserializeJobSchedulingError(JsonElement element)
        {
            ...
            return new JobSchedulingError(category, code, message, Optional.ToList(details));
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static JobSchedulingError FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeJobSchedulingError(document.RootElement);
        }
