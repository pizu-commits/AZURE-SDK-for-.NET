...
namespace Azure.Compute.Batch
{
    ...
    public partial class BatchServiceClient
    {
        ...
        public BatchServiceClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new BatchServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public BatchServiceClient(Uri endpoint, TokenCredential credential, BatchServiceClientOptions options)
        {
        ...
        public virtual Applications GetApplicationsClient(string apiVersion = "2022-10-01.16.0")
        {
            ...
            return new Applications(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
        ...
        public virtual Pool GetPoolClient(string apiVersion = "2022-10-01.16.0")
        {
            ...
            return new Pool(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
        ...
        public virtual Account GetAccountClient(string apiVersion = "2022-10-01.16.0")
        {
            ...
            return new Account(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
        ...
        public virtual Job GetJobClient(string apiVersion = "2022-10-01.16.0")
        {
            ...
            return new Job(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
        ...
        public virtual Certificates GetCertificatesClient(string apiVersion = "2022-10-01.16.0")
        {
            ...
            return new Certificates(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
        ...
        public virtual File GetFileClient(string apiVersion = "2022-10-01.16.0")
        {
            ...
            return new File(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
        ...
        public virtual JobSchedule GetJobScheduleClient(string apiVersion = "2022-10-01.16.0")
        {
            ...
            return new JobSchedule(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
        ...
        public virtual Task GetTaskClient(string apiVersion = "2022-10-01.16.0")
        {
            ...
            return new Task(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
        ...
        public virtual ComputeNodes GetComputeNodesClient(string apiVersion = "2022-10-01.16.0")
        {
            ...
            return new ComputeNodes(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
        ...
        public virtual ComputeNodeExtensions GetComputeNodeExtensionsClient(string apiVersion = "2022-10-01.16.0")
        {
            ...
            return new ComputeNodeExtensions(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, apiVersion);
        }
    }
}
