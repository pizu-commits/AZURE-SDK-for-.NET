...
{
    /// <summary> The BatchJobNetworkConfiguration. </summary>
    public partial class BatchJobNetworkConfiguration
    {
        ...
        internal BatchJobNetworkConfiguration(string subnetId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SubnetId = subnetId;
