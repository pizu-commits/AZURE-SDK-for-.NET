...
namespace Azure.Communication.CallAutomation
{
    ...
    public class CallConnection
    {
        ...
        internal CallConnection(string callConnectionId, CallConnectionRestClient callConnectionRestClient, CallMediaRestClient callCallMediaRestClient, CallDialogRestClient callDialogRestClient, ClientDiagnostics clientDiagnostics, CallAutomationEventProcessor eventProcessor, AzureCommunicationServicesRestClient azureCommunicationServicesRestClient)
        {
        ...
        public virtual CallConnection GetCallConnection(string callConnectionId)
        {
            ...
            try
            {
                return new CallConnection(callConnectionId, RestClient, CallMediaRestClient, CallDialogRestClient,  _clientDiagnostics, EventProcessor, AzureCommunicationServicesRestClient);
            }
            catch (Exception ex)
            {
                scope.Failed(ex);
